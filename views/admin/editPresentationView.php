...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Modifications - Présentation</h1>
                <h2 class="page-subhead-line">Cette section permet de modifier le contenu du bloc "Présentation" sur le site</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
...
<?php
    $htmlTitle = 'Modifications > Présentation | Admin | Cabinet G.KAUFMANN';
