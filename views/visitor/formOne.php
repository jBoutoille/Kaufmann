	...
	<div class="containerText">
		<form action="./?treatment" method="POST">
			<div class="inputData">
				...
				<input type="text" class="form-control wow fadeInUp foo-3" name="visitorRdvNom" required>
			</div>
			<div class="inputData">
				<label class="foo-3">Prénom :</label>
				<input type="text" class="form-control wow fadeInUp foo-3" name="visitorRdvPrenom" required>
			</div>
			<div class="inputData">
				<label class="foo-3">Activité :</label>
				<input type="text" class="form-control wow fadeInUp foo-3" name="visitorRdvActivite" required>
			</div>
			<div class="inputData">
				<label class="foo-3">Téléphone :</label>
				<input type="number" class="form-control wow fadeInUp foo-3" name="visitorRdvTelephone" required>
			</div>
			<div class="inputData">
				<label class="foo-3">E-mail :</label>
				<input type="email" class="form-control wow fadeInUp foo-3" name="visitorRdvMail" required>
			</div>
			<div class="inputData">
				<label class="foo-3">Message :</label>
				<textarea rows="3" class="form-control wow fadeInUp foo-3" name="visitorRdvMessage" required></textarea>
			</div>
